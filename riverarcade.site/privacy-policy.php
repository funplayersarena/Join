        ...
        <div class="header">
            ...
            <div class="user-numbers">
                ...
                <div class="privacy-content">
                    <h3>At riverarcade.site, we are committed to protecting your privacy.</h3>
                    <p>This Privacy Policy outlines the type of information collected from users of our website and how
                        that information is used and safeguarded. By using our site, you consent to the practices
                        described in this policy.</p>

                    <h3>1. Information Collected</h3>
                    <p>We may collect personal information from you, such as your name, email address, mailing address,
                        phone number, or other details when you voluntarily provide it to us. This information is used
                        to personalize your experience, respond to your inquiries, and improve our services.</p>

                    <p>In addition, we may automatically collect certain non-personal information when you visit our
                        site, such as your IP address, browser type, operating system, and the pages you viewed. This
                        information is collected to analyze trends, administer the site, track user movements, and
                        gather demographic information.</p>

                    <h3>2. Use of Information</h3>
                    <p>The information we collect is used solely for the purposes stated at the time of collection, or
                        as otherwise required by law. We may use your personal information to:</p>
                    <ul>
                        <li>Provide and personalize our services to better meet your needs.</li>
                        <li>Communicate with you regarding your inquiries and provide customer support.</li>
                        <li>Send periodic emails or newsletters with relevant information.</li>
                        <li>Conduct data analysis and research to improve our website and services.</li>
                        <li>Comply with legal obligations and protect against unauthorized access or use.</li>
                    </ul>
                    <p>We do not sell, trade, or rent your personal information to third parties without your explicit
                        consent.</p>

                    <h3>3. Cookies and Tracking Technologies</h3>
                    <p>We use cookies and similar tracking technologies to enhance your browsing experience on our site.
                        Cookies are small files that are stored on your device and enable certain features and
                        functionality, such as remembering your preferences or allowing you to
